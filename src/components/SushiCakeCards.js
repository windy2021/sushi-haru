    ...
    <>
      ...
      <div className="container text-center bg-light-subtle pt-5">
        ...
        <div className="row">
          ...
          ></CardBootstrap>
          <CardBootstrap
            src="./images/sushi_haru/sushi_cake_5_2.jpg"
            title="IDR 252k"
          ...
          ></CardBootstrap>
          <CardBootstrap
            src="./images/sushi_haru/sushi_cake_5_3.jpg"
            title="IDR 240k"
            subtitle="5 SUSHI ROLLS | D 20CM (40pcs)"
        ...
        <div className="row">
          <CardBootstrap
            src="./images/sushi_haru/sushi_cake_6_1.jpg"
            title="IDR 215k"
          ...
          ></CardBootstrap>
          <CardBootstrap
            src="./images/sushi_haru/sushi_cake_6_2.jpg"
            title="IDR 291k"
        ...
        <div className="row">
          <CardBootstrap
            src="./images/sushi_haru/sushi_cake_6_3.jpg"
            title="IDR 232k"
          ...
          ></CardBootstrap>
          <CardBootstrap
            src="./images/sushi_haru/sushi_cake_6_4.jpg"
            title="IDR 260k"
        ...
        <div className="row">
          <CardBootstrap
            src="./images/sushi_haru/sushi_cake_8_1.jpg"
            title="IDR 291k"
          ...
          ></CardBootstrap>
          <CardBootstrap
            src="./images/sushi_haru/sushi_cake_8_2.jpg"
            title="IDR 327k"
          ...
          ></CardBootstrap>
          <CardBootstrap
            src="./images/sushi_haru/sushi_cake_8_3.jpg"
            title="IDR 327k"
            subtitle="8 SUSHI ROLLS | D 25CM (64pcs)"
